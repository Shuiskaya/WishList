...
public class MainAdapter2 extends FirebaseRecyclerAdapter<Gift, MainAdapter2.myViewHolder> {
    public int count;
     ...
     * @param options
     */
    public MainAdapter2(@NonNull FirebaseRecyclerOptions<Gift> options) {
        super(options);
    }
    ...
    protected void onBindViewHolder(@NonNull myViewHolder holder, int position, @NonNull Gift model) {
        ...
        holder.gift_card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), ComleteGiftShowActivity.class);
