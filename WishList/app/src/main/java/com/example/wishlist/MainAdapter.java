...
public class MainAdapter extends FirebaseRecyclerAdapter<Gift,MainAdapter.myViewHolder> {
    public int count;
     ...
     * @param options
     */
    public MainAdapter(@NonNull FirebaseRecyclerOptions<Gift> options) {
        super(options);
    }
    ...
    protected void onBindViewHolder(@NonNull myViewHolder holder, int position, @NonNull Gift model) {
        ...
        holder.gift_card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), ChangeGiftActivity.class);
